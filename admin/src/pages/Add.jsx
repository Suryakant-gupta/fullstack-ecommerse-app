  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
      ...
      <div className="w-full">
        ...
        <textarea onChange={(e)=>setDescription(e.target.value)} value={description} type="text" placeholder='Write content here'  required className='w-full max-w-[500px] px-3 py-2'></textarea>
      </div>
      ...
      <div className="flex gap-2 mt-2">
        ...
        <label className='cursor-pointer ' htmlFor="besetseller">Add to bestseller</label>
      </div>

       <button type="submit" className='w-28 py-2.5 mt-4 bg-black text-white'>Add</button>
